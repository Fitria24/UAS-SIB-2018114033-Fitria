    ...
    <form action="/mahasiswas/{{$mahasiswa['id']}}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <strong>Nama Mahasiswa:</strong>
                <input type="string" name="nama_mahasiswa" id="exampleInputPassword1"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <input type="string" name="alamat" id="exampleInputPassword1"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <strong>No Telepon:</strong>
                <input type="integer" name="no_tlp" id="exampleInputPassword1"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
            <strong>Email</strong>
            <input type="string" name="email" id="exampleInputPassword1"
